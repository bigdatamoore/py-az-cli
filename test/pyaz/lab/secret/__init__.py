...
def set(resource_group, lab_name, __USER_NAME=None, name, value):
    params = get_params(locals())   
    command = "az lab secret set " + params
    print(command)
...
def show(resource_group, lab_name, __USER_NAME=None, name, expand=None):
    params = get_params(locals())   
    command = "az lab secret show " + params
    print(command)
    output = subprocess.run(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout =  output.stdout.decode("utf-8")
    stderr = output.stderr.decode("utf-8")
...
def list(resource_group, lab_name, __USER_NAME=None, expand=None, filter=None, top=None, orderby=None):
    params = get_params(locals())   
    command = "az lab secret list " + params
    print(command)
    output = subprocess.run(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout =  output.stdout.decode("utf-8")
    stderr = output.stderr.decode("utf-8")
...
def delete(resource_group, lab_name, __USER_NAME=None, name):
    params = get_params(locals())   
    command = "az lab secret delete " + params
    print(command)
    output = subprocess.run(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout =  output.stdout.decode("utf-8")
    stderr = output.stderr.decode("utf-8")
