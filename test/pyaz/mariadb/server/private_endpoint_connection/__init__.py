...
def approve(id=None, resource_group=None, server_name=None, name=None, description=None):
    ...
    command = "az mariadb server private-endpoint-connection approve " + params
    print(command)
...
def reject(id=None, resource_group=None, server_name=None, name=None, description=None):
    params = get_params(locals())   
    command = "az mariadb server private-endpoint-connection reject " + params
    print(command)
    output = subprocess.run(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout =  output.stdout.decode("utf-8")
    stderr = output.stderr.decode("utf-8")
...
def delete(id=None, resource_group=None, server_name=None, name=None):
    params = get_params(locals())   
    command = "az mariadb server private-endpoint-connection delete " + params
    print(command)
    output = subprocess.run(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout =  output.stdout.decode("utf-8")
    stderr = output.stderr.decode("utf-8")
...
def show(id=None, resource_group=None, server_name=None, name=None):
    params = get_params(locals())   
    command = "az mariadb server private-endpoint-connection show " + params
    print(command)
    output = subprocess.run(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout =  output.stdout.decode("utf-8")
    stderr = output.stderr.decode("utf-8")
