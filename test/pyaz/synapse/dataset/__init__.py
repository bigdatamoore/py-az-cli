...
def create(workspace_name, name, file, no_wait=None):
    ...
    command = "az synapse dataset create " + params
    print(command)
...
def set(workspace_name, name, file, no_wait=None):
    params = get_params(locals())   
    command = "az synapse dataset set " + params
    print(command)
    output = subprocess.run(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout =  output.stdout.decode("utf-8")
    stderr = output.stderr.decode("utf-8")
...
def list(workspace_name):
    params = get_params(locals())   
    command = "az synapse dataset list " + params
    print(command)
    output = subprocess.run(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout =  output.stdout.decode("utf-8")
    stderr = output.stderr.decode("utf-8")
...
def show(workspace_name, name):
    params = get_params(locals())   
    command = "az synapse dataset show " + params
    print(command)
    output = subprocess.run(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout =  output.stdout.decode("utf-8")
    stderr = output.stderr.decode("utf-8")
...
def delete(workspace_name, name, yes=None, no_wait=None):
    params = get_params(locals())   
    command = "az synapse dataset delete " + params
    print(command)
    output = subprocess.run(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout =  output.stdout.decode("utf-8")
    stderr = output.stderr.decode("utf-8")
